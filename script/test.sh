...
vllm serve /home/g00955623/weights/DeepSeek-V4-Flash \
    ...
    --additional-config '{"multistream_overlap_shared_expert": false,"enable_cpu_binding":true, "expert_offload_config": {"expert_offload": true, "enable_multi_card": false, "num_device_experts": 32, "num_device_layers": 2, "cache_policy_enabled": true, "expert_prefetch_enabled": true, "expert_prefetch_num":1, "moe_offload_debug": false}}' \
    # --quantization ascend \
